...
### Fixed
- `ActivityTrackable`: skip tracking when the `X-Sec-Purpose: prefetch` header is present, preventing browser speculative prefetch requests from being recorded as user activity
